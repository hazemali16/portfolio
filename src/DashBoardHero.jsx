        ...
        fetch("http://127.0.0.1:8000/hero/", {
            ...
            .then((result) => {
                if (result.results == 0) {
                    ...
                    formData.children[0].children[1].value = result.results[0].name;
                    formData.children[1].children[1].value =
                        result.results[0].description;
                    formData.children[2].children[0].children[1].children[0].src =
                        result.results[0].image;
                    formData.children[2].children[0].children[1].children[2].children[0].innerHTML =
                        result.results[0].image_name;
                    formData.children[2].children[0].children[1].children[2].children[1].innerHTML =
                        result.results[0].image_size + " - " + result.results[0].image_type;
                    formData.children[2].children[0].children[1].children[0].classList.remove(
                        "hidden"
                    );
                    formData.children[2].children[0].children[1].children[1].removeAttribute(
                        "required"
                    );
                }
            })
            .catch((error) => console.error(error));
        let uploadHeroImage = document.querySelector(".upload-hero-image");
        let heroImageInput = document.querySelector(".hero-image-input");
                    ...
                    <div className="p-10">
                        ...
                        <form
                            ...
                            onSubmit={(e) => {
                                ...
                                let description = e.target.children[1].children[1].value;
                                let image =
                                    e.target.children[2].children[0].children[1].children[1]
                                        .files[0];
                                let image_name =
                                    e.target.children[2].children[0].children[1].children[2]
                        ...
                        >
                            <div className="mb-5 flex flex-col gap-3 text-[var(--pragraph-color)]">
                                ...
                                <input
                                    required
                                    className="rounded-xl bg-[var(--color-primary)] border-none outline-none px-5 py-3"
                                    type="text"
                                    name="name"
                                />
                            </div>
                            ...
                            <div className="mb-5 flex flex-col gap-3 text-[var(--pragraph-color)]">
                                <div className="mt-8">
                                    ...
                                    <div className="rounded-lg outline-none bg-[var(--color-primary)] p-10 resize-none min-h-40 flex justify-center max-lg:flex-col items-center gap-10 cursor-pointer upload-hero-image">
                                        <img className="min-w-32 h-60 hidden" src="" alt="Hero" />
                                        <input
                                            type="file"
                                            className="rounded-lg outline-none bg-[var(--color-primary)] p-5 cursor-pointer hidden hero-image-input"
                                            name="image"
                                            required
                                            accept="image/*"
                                        />
